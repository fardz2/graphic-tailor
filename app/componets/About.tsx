...
export default function About() {
  return (
    <>
      <section className="bg-[#F5F8FE] md:py-20 py-5" id="about">
        <div className="relative container mx-auto px-5 md:px-24  ">
          <div className="flex  justify-center md:mt-0 mt-20  flex-col-reverse lg:flex-row gap-20 lg:items-start items-center">
            <div className="">
